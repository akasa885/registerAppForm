            ...
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md md:shadow-sm shadow-lg">
                ...
                @if ($message = Session::get('info'))
                    ...
                    <div class="alert alert-info bg-blue-100 rounded-lg py-5 px-6 w-full alert-dismissible fade show"
                        role="alert">
                        <svg width="24" height="24" class="alert-icon w-10 h-10" viewBox="0 0 24 24" fill="none"
                ...
                <div class="flex flex-col justify-around items-center p-6 items-center">
                    ...
                    <span class="text-red-500 text-xs font-bold italic">Please Don't close or leave this page before you
                        complete the payment</span>
                ...
                <div class="flex justify-center items-center p-6">
                    <a href="javascript:void();" id="redirect_to_payment_page"
                        data-redirect="{{ !$finished ? $order->snap_redirect : '#' }}" aria-label="to payment page"
    ...
    <script>
        let page_paymentProcess = function() {
            ...
            @if (!$finished)
                ...
                let dueTime = new Date(payment_due_time).toLocaleString("en-US", {
                    timeZone: TIME_ZONE
                });
                ...
                let x = setInterval(function() {
                    ...
                    TIME_LEFT_PAYMENT.innerHTML = formatNumber(hours) + ":" + formatNumber(minutes) + ":" +
