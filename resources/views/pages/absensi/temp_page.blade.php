@extends('layouts.app')
@section('title', $link?->title ?? 'Link Absensi Tidak Tersedia')
    ...
    <main class="flex justify-center py-10 sm:container sm:mx-auto">
        <div class="lg:w-6/12 sm:px-6 sm:w-10/12">
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                @if (!$show)
                    <h3 class="font-semibold p-10 sm:mx-auto">Link Tidak Tersedia / Sudah ditutup</h3>
                ...
                @else
                    ...
                    <form class="w-full px-6 mb-5 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <span
                                class="text-gray-600 text-xs mt-2 w-full">Isikan dengan nama lengkap beserta gelar.</span><br />
