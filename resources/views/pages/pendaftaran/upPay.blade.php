                            ...
                            @if (config('app.locale') == 'id')
                                ...
                                <p>
                                    Terima kasih telah melakukan pendaftaran {{ $link->title }}.<br> <strong> Informasi
                                        terkait pembayaran telah kami kirimkan ke email anda: Silahkan Cek Inbox / Spam
                                        Email </strong>, <br>Silahkan upload
                            ...
                            @else
                                ...
                                <p>
                                    Thank you for registering {{ $link->title }}.<br> <strong> Payment information has
                                        been sent to your email: Please Check Inbox / Spam Email </strong>, <br> Please
