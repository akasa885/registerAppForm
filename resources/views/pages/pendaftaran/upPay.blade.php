                    ...
                    <form class="w-full px-6 mb-5 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                        ...
                        @else
                            @if (config('app.locale') == 'id')
                                <p class="sm:mt-4">Kepada Bpk/Ibu, <strong> {{ $member->full_name }} </strong> </p>
                                <p>
                                    Terima kasih telah melakukan pendaftaran {{ $link->title }}.<br> <strong>
                                        Informasi
                            ...
                            @else
                                ...
                                <p>
                                    Thank you for registering {{ $link->title }}.<br> <strong> Payment information has
                                        been sent to your email. Please open it in Inbox / Spam </strong>, <br>Please
                                    upload
        ...
        $('document').ready(function() {
            @if ($timeLeft)
                var timerCounter = () => {
                    ...
                    // count time left array if 4 then it's have day
                    if (time_left_array.length == 4) {
                        let days = time_left_array[0];
                        let hours = time_left_array[1];
                        let minutes = time_left_array[2];
                        let seconds = time_left_array[3];
                        let x = setInterval(function() {
                            ...
                            time_left_payment.innerHTML = days + "D:" + hours + ":" + minutes + ":" +
                                seconds;
