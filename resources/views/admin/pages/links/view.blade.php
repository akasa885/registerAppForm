    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>List Pertanyaan
                    <div class="page-title-subheading">This is an question panel that you can manage your questions
                    </div>
                </div>
            </div>
        </div>
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            html += `<span class="fw-bolder">${data}</span><br/>`;
                            html +=
                                `<span class="text-muted">Tipe: <span class="text-danger">${row.link_type}</span></span><br/>`;
